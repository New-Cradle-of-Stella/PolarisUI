...
namespace Polaris.UI.Wire
{
    ...
    /// <see cref="BackendType"/> 指名的一个实现了 <c>Polaris.UI.IPuiCustomControl</c> 的类
    ...
    public sealed class PuiCustomParams
    {
        ...
        /// <summary>实现 <c>Polaris.UI.IPuiCustomControl</c> 的后端类型全名（如 <c>MyMod.Controls.MyGraphControl</c>）。</summary>
